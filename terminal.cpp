...
#include "common.h"
#include "commonw.h"
#include "pimage_mgr.h"  //  dbg_flags and constants
#include "cterminal.h" 
#include "terminal.h"
#include "winmsgs.h"
...
void setup_terminal_window(HWND hwnd, uint StatusBarHeight, uint bottom_ref_control)
{
   ...
   // syslog("term window: X: %u, Y: %u, lvdy: %u\n", cxClient, cyClient, lvdy);
   // syslog("X: %u = %u - %u\n", cxClient, myRect.right, myRect.left) ;
   // syslog("Y: %u = %u - %u, cb: %u, sbh: %u, lvdy: %u\n", 
   //    cyClient, myRect.bottom, myRect.top, ctrl_bottom, StatusBarHeight, lvdy) ;
